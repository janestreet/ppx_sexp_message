  ...
  eg
    (let ppx_sexp_message x__001_ y__002_ =
       Ppx_sexp_conv_lib.Sexp.List
         ...
         ; Ppx_sexp_conv_lib.Sexp.List
             [ Ppx_sexp_conv_lib.Sexp.Atom "y"; (sexp_of_string [@merlin.hide]) y__002_ ]
         ; Ppx_sexp_conv_lib.Sexp.List
  ...
  eg
    (let ppx_sexp_message x__003_ y__004_ =
       Ppx_sexp_conv_lib.Sexp.List
         ...
         ; Ppx_sexp_conv_lib.Sexp.List
             [ Ppx_sexp_conv_lib.Sexp.Atom "y"; (sexp_of_string [@merlin.hide]) y__004_ ]
         ; Ppx_sexp_conv_lib.Sexp.List
  ...
  eg
    (let ppx_sexp_message y__006_ =
       Ppx_sexp_conv_lib.Sexp.List
         ...
         ; Ppx_sexp_conv_lib.Sexp.List
             [ Ppx_sexp_conv_lib.Sexp.Atom "y"; (sexp_of_string [@merlin.hide]) y__006_ ]
         ]
         [@@cold]
     in
  ...
  eg
    (let ppx_sexp_message x__010_ y__011_ =
       Ppx_sexp_conv_lib.Sexp.List
         ...
         ; Ppx_sexp_conv_lib.Sexp.List
             [ Ppx_sexp_conv_lib.Sexp.Atom "y"; (sexp_of_string [@merlin.hide]) y__011_ ]
         ]
         [@@cold]
     in
     ppx_sexp_message x y [@nontail]);
  eg
    (let ppx_sexp_message x__012_ y__013_ =
       Ppx_sexp_conv_lib.Sexp.List
         ...
         ; Ppx_sexp_conv_lib.Sexp.List
             [ Ppx_sexp_conv_lib.Sexp.Atom "y"; (sexp_of_string [@merlin.hide]) y__013_ ]
         ]
         [@@cold]
     in
     ppx_sexp_message x y [@nontail]);
...
let _ =
  ...
  eg
    (let ppx_sexp_message () =
     ...
     ppx_sexp_message () [@nontail]);
  eg
    (let ppx_sexp_message x__020_ y__021_ =
       Ppx_sexp_conv_lib.Sexp.List
         [ Ppx_sexp_conv_lib.Conv.sexp_of_string__stack "foo"
         ; Ppx_sexp_conv_lib.Sexp.List
     ...
     ppx_sexp_message x y [@nontail]);
  eg
    (let ppx_sexp_message x__022_ y__023_ =
       Ppx_sexp_conv_lib.Sexp.List
         [ Ppx_sexp_conv_lib.Conv.sexp_of_string__stack "foo"
         ; Ppx_sexp_conv_lib.Sexp.List
             [ Ppx_sexp_conv_lib.Sexp.Atom "x"
     ...
     ppx_sexp_message x y [@nontail]);
  eg
    (let ppx_sexp_message x__024_ =
       Ppx_sexp_conv_lib.Sexp.List
         [ Ppx_sexp_conv_lib.Conv.sexp_of_string__stack "foo"
         ; (sexp_of_int__stack [@merlin.hide]) x__024_
         ; Ppx_sexp_conv_lib.Conv.sexp_of_int__stack 1
         ; Ppx_sexp_conv_lib.Sexp.List
             [ Ppx_sexp_conv_lib.Sexp.Atom "blah"; (sexp_of_int__stack [@merlin.hide]) 0 ]
         ]
         [@@cold]
     in
     ppx_sexp_message x [@nontail]);
  ...
  eg
    (let ppx_sexp_message () =
     ...
     ppx_sexp_message () [@nontail]);
  eg
    (let ppx_sexp_message y__026_ y__027_ =
       Ppx_sexp_conv_lib.Sexp.List
  ...
  eg
    (let ppx_sexp_message () =
     ...
     ppx_sexp_message () [@nontail]);
  eg
    (let ppx_sexp_message x__028_ =
       Ppx_sexp_conv_lib.Sexp.List
         [ Ppx_sexp_conv_lib.Sexp.Atom "x"; (sexp_of_int__stack [@merlin.hide]) x__028_ ]
         [@@cold]
     in
     ppx_sexp_message x [@nontail]);
  eg
    (let ppx_sexp_message x__029_ y__030_ =
       Ppx_sexp_conv_lib.Sexp.List
         [ Ppx_sexp_conv_lib.Sexp.List
             [ Ppx_sexp_conv_lib.Sexp.Atom "x"
     ...
     ppx_sexp_message x y [@nontail]);
  eg
    (let ppx_sexp_message x__031_ y__032_ =
       Ppx_sexp_conv_lib.Sexp.List
  ...
  eg
    (let ppx_sexp_message () = Ppx_sexp_conv_lib.Sexp.List [] [@@cold] in
     ppx_sexp_message () [@nontail]);
  eg
    (let ppx_sexp_message record_a__033_ record_b_contents__034_ =
       Ppx_sexp_conv_lib.Sexp.List
         [ Ppx_sexp_conv_lib.Sexp.List
             [ Ppx_sexp_conv_lib.Sexp.Atom "record.a"
  ...
  eg
    (let ppx_sexp_message () =
       match
         match
           ( (fun [@merlin.hide] x__035_ -> sexp_of_list__stack sexp_of_int__stack x__035_)
               [ 1 ]
           , match
               ( (fun [@merlin.hide] x__036_ ->
  ...
  eg
    (let ppx_sexp_message () =
       match
         match
           ( (fun [@merlin.hide] x__037_ -> sexp_of_list__stack sexp_of_int__stack x__037_)
               [ 1 ]
           , match
               ( (fun [@merlin.hide] x__038_ ->
